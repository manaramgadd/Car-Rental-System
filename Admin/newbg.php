					...
					<ul class="navbar-nav">
						...
						<li class="nav-item dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li><a class="dropdown-item" data-toggle="modal" data-target="#custinfo"> Reservations
										Of Customer by Email
									</a></li>
								<li><a class="dropdown-item" data-toggle="modal" data-target="#daily"> Daily Payments
									</a></li>
							</ul>
						</li>
						</li>
